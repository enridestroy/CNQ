...
if grep -q remoteObjectAccessor.host /opt/tomcat/conf/context.xml; then
  ...
  cp -f /opt/tomcat/conf/context.xml /opt/tomcat/conf/context.xml.old
  sed '36 a <Environment name="remoteObjectAccessor.host" value="core.jboss.pp.cdnq.lan" type="java.lang.String" override="false"\/>' /opt/tomcat/conf/context.xml > /opt/tomcat/conf/c1.xml
